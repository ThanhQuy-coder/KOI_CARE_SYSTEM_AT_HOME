...
//        => optionsBuilder.UseSqlServer("Data Source=LAPTOP-58P0M9U0;Initial Catalog=KoiCareSystemAtHome;Integrated Security=True;Trust Server Certificate=True");
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.HasKey(e => e.AccountId).HasName("PK__Account__349DA5866037D800");

            entity.ToTable("Account");

            entity.HasIndex(e => e.Username, "UQ__Account__536C85E4346AF449").IsUnique();

            entity.HasIndex(e => e.Email, "UQ__Account__AB6E6164828C56EB").IsUnique();
        ...
        {
            entity.HasKey(e => e.FeedingScheduleId).HasName("PK__FeedingS__1B08C8453BE2ACD0");
        ...
        {
            entity.HasKey(e => e.FishId).HasName("PK__KoiFish__5222DA393F753994");
        ...
        {
            entity.HasKey(e => e.PostId).HasName("PK__News__DD0C73BA41DD23B3");

            entity.HasIndex(e => e.Author, "UQ__News__C2E6DB6758D63111").IsUnique();
        ...
        {
            entity.HasKey(e => e.PondId).HasName("PK__Pond__D18BF8546C9E9012");
        ...
        {
            entity.HasKey(e => e.ProductId).HasName("PK__tmp_ms_x__2D10D14AD0A5C0D3");
            ...
            entity.HasOne(d => d.User).WithMany(p => p.Products)
                .HasForeignKey(d => d.UserId)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK___Product__UserId__5DCAEF64");
        });

        modelBuilder.Entity<SaltCalculation>(entity =>
        {
            entity.HasKey(e => e.SaltCalculationId).HasName("PK__SaltCalc__69E08378FD8E1058");
        ...
        {
            entity.HasKey(e => e.UserId).HasName("PK___User__1788CC4C83BBE6B7");
        ...
        {
            entity.HasKey(e => e.WaterParameterId).HasName("PK__WaterPar__74A7C6F21D6C1063");
