...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see https://go.microsoft.com/fwlink/?LinkId=723263.
        => optionsBuilder.UseSqlServer("Data Source=DESKTOP-8BQ7UV2;Initial Catalog=KoiCareSystemAtHome;Integrated Security=True;Encrypt=True;Trust Server Certificate=True");

    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        modelBuilder.Entity<Account>(entity =>
        {
            entity.HasKey(e => e.AccountId).HasName("PK__Account__349DA5866A99760D");

            entity.ToTable("Account");

            entity.HasIndex(e => e.Username, "UQ__Account__536C85E413B716DC").IsUnique();

            entity.HasIndex(e => e.Email, "UQ__Account__AB6E6164ADD1015E").IsUnique();
        ...
        {
            entity.HasKey(e => e.FeedingScheduleId).HasName("PK__FeedingS__1B08C8454BC9F609");
        ...
        {
            entity.HasKey(e => e.FishId).HasName("PK__KoiFish__5222DA39A117535D");
        ...
        {
            entity.HasKey(e => e.PostId).HasName("PK__News__DD0C73BA0F88E8CB");

            entity.HasIndex(e => e.Author, "UQ__News__C2E6DB672F602CED").IsUnique();
        ...
        {
            entity.HasKey(e => e.PondId).HasName("PK__Pond__D18BF8549C0CFB3E");
        ...
        {
            entity.HasKey(e => e.ProductId).HasName("PK___Product__2D10D14A25A4634B");
        ...
        {
            entity.HasKey(e => e.SaltCalculationId).HasName("PK__SaltCalc__69E083787CB7F9EB");
        ...
        {
            entity.HasKey(e => e.UserId).HasName("PK___User__1788CC4CDEB9DA3F");
        ...
        {
            entity.HasKey(e => e.WaterParameterId).HasName("PK__WaterPar__5D1C0C72CA2963A2");
